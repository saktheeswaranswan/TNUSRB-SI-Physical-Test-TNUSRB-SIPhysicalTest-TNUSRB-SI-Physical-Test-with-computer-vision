...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        for idx, landmark in enumerate(results.pose_landmarks.landmark):
            ...
            # Check if landmarks 13 (right wrist) and 14 (right thumb) cross the line
            if idx == mp_pose.PoseLandmark.RIGHT_WRIST.value or idx == mp_pose.PoseLandmark.RIGHT_THUMB.value:
